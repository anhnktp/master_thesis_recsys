...
class SEC3NCF(nn.Module):
    ...
    def __init__(self, num_user, num_item, num_factor, dropout, model_type, GMF_model=None, MLP_model=None):
        ...
        self.conv1 = nn.Conv2d(1, num_factor, (3,2))
    ...
    def forward(self, user, item):
        ...
        output_MLP = embed_user_MLP * embed_item_MLP
        stack = torch.stack([embed_user_GMF, embed_item_GMF, output_MLP], dim=-2)
