...
class GMF(nn.Module):
    ...
    def _init_weight_(self):
        ...
        if not self.GMF_model:
            ...
            # embedding layers
            self.embed_user_GMF.weight = self.GMF_model.embed_user_GMF.weight
            self.embed_item_GMF.weight = self.GMF_model.embed_item_GMF.weight
            # predict layers
            self.predict_layer.weight, self.predict_layer.bias = self.GMF_model.predict_layer.weight, self.GMF_model.predict_layer.bias
